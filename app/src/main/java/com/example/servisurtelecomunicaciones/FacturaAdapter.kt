...
class FacturaAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.tvEst.setTextColor(ctx.getColor(
    ...
    private fun showDetailDialog(ctx: Context, f: Factura, pos: Int) {
        ...
        dialogView.findViewById<TextView>(R.id.tvDetEstado).apply {
            ...
            setTextColor(ctx.getColor(
                if (f.estado=="pagada") android.R.color.holo_green_dark
    ...
    private fun changeEstadoDialog(ctx: Context, f: Factura, pos: Int) {
        ...
        val sel  = opts.indexOfFirst { it.equals(f.estado, true) }.takeIf{it>=0} ?:0
        AlertDialog.Builder(ctx)
